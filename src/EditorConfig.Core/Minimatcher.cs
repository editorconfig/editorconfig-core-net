...
/*
 * Minitmatcher https://github.com/SLaks/Minimatch
 * Moved to source code dependency because we need explicit NET45 builds
 * Renamed to avoid conflicts and be smurflytyped to clearly indicate that we are acting a little dirty
 */
...
namespace EditorConfig.Core
{
    ...
    public class EditorConfigMinimatcherOptions
    {
    ...
    public class EditorConfigMinimatcher
    {
        ...
        public static bool Check(string input, string pattern, EditorConfigMinimatcherOptions options = null)
        {
            ...
            return new EditorConfigMinimatcher(pattern, options).IsMatch(input);
        }
        ...
        public static Regex CreateRegex(string pattern, EditorConfigMinimatcherOptions options = null)
        {
            return new EditorConfigMinimatcher(pattern, options).MakeRegex();
        }


        readonly EditorConfigMinimatcherOptions options;
        ...
        public EditorConfigMinimatcher(string pattern, EditorConfigMinimatcherOptions options = null)
        {
            if (pattern == null) throw new ArgumentNullException("pattern");
            this.options = options ?? new EditorConfigMinimatcherOptions();
        ...
        public static IEnumerable<string> BraceExpand(string pattern, EditorConfigMinimatcherOptions options)
        {
